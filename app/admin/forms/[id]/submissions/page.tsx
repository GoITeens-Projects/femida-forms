...
export default async function SubmissionsPage({ params }: SubmissionsPageProps) {
  ...
  const renderAnswer = (field: FormField, answer: string | string[] | boolean | undefined) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <Link href="/admin" className="mb-2 inline-flex items-center text-sm text-muted-foreground hover:text-foreground">
                    ...
                    <TableRow key={submission.id}>
                      <TableCell className="sticky left-0 bg-card">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium">{submission.user?.username || 'Unknown'}</span>
                        </div>
                      </TableCell>
